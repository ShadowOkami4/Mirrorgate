...
The complete collection is planned to contain **18 journeys**. These numbers describe the intended final collection and may change as the setting is developed and playtested.

| Format | Planned | Current focus |
| --- | ---: | --- |
| One-shots | 10 | Concept planning |
| Short adventures | 5 | **The Pack in the Twilight — 5%** |
| Campaign frameworks | 3 | **Shattered Hope — 1%** |
...
> [!WARNING]
> Most images currently contained in this vault and repository are AI-generated visual aids and temporary representations. Project-created images are shared under the same CC BY 4.0 license to the extent that copyright or related rights exist.
>
> Artists are warmly invited to contribute original artwork that can be released under CC BY 4.0. Accepted work will be clearly credited to its respective creator.
